                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-group ">
                            ...
                            <input type="text" name="poids" value="{{old('poids')}}" class="form-control @error('poids') is-invalid @enderror" id="" placeholder="Poids du bénéficiaire">
                            @error('poids')
                                <div class="invalid-feedback">
                                    {{$errors->first('poids')}}
                                </div>
